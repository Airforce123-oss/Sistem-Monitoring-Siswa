<template>
    <div class="antialiased bg-gray-50 dark:bg-gray-900">
        ...
        <main class="p-4 md:ml-64 h-auto pt-20">
            ...
            >
                <div
                    class="border-2 border-solid border-gray-300 rounded-lg dark:border-gray-600 h-20 md:h-34"
                >
                    <h2 class="text-center">Siswa</h2>
                </div>
                <div
                    class="border-2 border-solid rounded-lg border-gray-300 dark:border-gray-600 h-20 md:h-34"
                >
                ...
                <div
                    class="border-2 border-solid rounded-lg border-gray-300 dark:border-gray-600 h-20 md:h-34"
                >
                    <h2 class="text-center">Total Kehadiran Siswaa</h2>
                </div>
                <div
                    class="border-2 border-solid rounded-lg border-gray-300 dark:border-gray-600 h-20 md:h-34"
                ></div>
