<template>
    <div class="antialiased bg-gray-50 dark:bg-gray-900">
        ...
        <main class="p-4 md:ml-64 h-auto pt-20">
            <div class="flex justify-start" style="font-size: 30px">
                <img src="" alt="" />
                <h1>Home</h1>
            </div>
            <div>
                <h1>Monitoring Siswa SMA Barunawati Surabaya</h1>
            </div>
            <div class="text-center mt-10" style="font-size: 30px">
                <h1>
                    Selamat Datang Admin di Website Monitoring Siswa Barunawati
                    Surabaya
                </h1>
            </div>
            <div class="rounded-lg h-100 mb-4" style="align-items: center">
                <img
